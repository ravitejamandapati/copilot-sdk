...
This folder contains standalone, executable C# examples for each cookbook recipe. These are [file-based apps](https://learn.microsoft.com/en-us/dotnet/core/sdk/file-based-apps) that can be run directly with `dotnet run`.
...
- [GitHub Copilot SDK Documentation](../../README.md)
